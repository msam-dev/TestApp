...
public class thinking_skills extends AppCompatActivity {
    public static final String SEND_USERNAME = "LOGOUT";
    DBHelper DB;
    Button submitTheAnswer;
    EditText answer;
    TextView questionContent;
    int[] questions = {26,27,28,21,32};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.thinking_skills);
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(thinking_skills.this);
        ...
        submitTheAnswer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(currentQuestion<4){
                    ...
                    String answerTXT = answer.getText().toString();
                    updateScore(questions[currentQuestion-1], answerTXT);
                    Toast t = Toast.makeText(thinking_skills.this, "You scored "+score+" out of 5", Toast.LENGTH_LONG);
                    t.show();
                    DB.updateQuizAttempt(quizAttemptNumber, userInfo, "Thinking Skills", score);
